...
public class Homework1 {
	...
	public static void main(String[] args) {
		...
		//naive way:
		// Systemm.out.println(2 + 4 + 6 + 8 + 10);
		...
		while(m <= 10)
		{
			...
			//sometimes, based on the logic you are dealing with, it might be reasonable to
			//put it at the beginning or even somewhere else within the { } of while
		}
